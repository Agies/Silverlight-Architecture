...
{
    [Export]
    public class EmployeeViewModel : DetailViewModel<EmployeeModel>
    {
        [ImportingConstructor]
        public EmployeeViewModel(IModelRepository<EmployeeModel> modelRepository) : base(modelRepository)
        {
